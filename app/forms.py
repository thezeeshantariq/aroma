    ...
    class Meta:
        ...
        widgets = {
            'number': forms.NumberInput(
                attrs={'class': 'form-control', 'placeholder': 'Number of table in resturant'}),
            'name': forms.TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Name of table'}),
            'image': forms.FileInput(attrs={'class': 'form-control', }),
        }

        labels = {
            'number': _('Table Number'),
            'name': _('Table Name (optional)'),
            'image': _('Image (Optional)'),
        }

        help_texts = {
            'name': _('Specify the number of table, which must be unique'),
            'name': _('Name of table if any'),
            'image': _('Image (Optional)'),
        }

        error_messages = {
            'number': {'required': _('The number of table is required')},
        }
